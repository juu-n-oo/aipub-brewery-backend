...
/**
 * OpenSearch 클라이언트 Bean. {@code dockerizer.opensearch.enabled=true} 일 때만 생성된다.
...
public class OpenSearchConfiguration {
    ...
    public OpenSearchClient openSearchClient(OpenSearchProperties properties) throws Exception {
        Objects.requireNonNull(properties.getUrl(), "dockerizer.opensearch.url must be configured");
